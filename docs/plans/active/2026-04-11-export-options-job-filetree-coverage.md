...
For Milestone 2, add focused renderer/parser/export tests before implementation:
    ...
    pnpm exec vitest run tests/parser/se4-parser.test.ts tests/markdown-renderer.test.ts tests/export-preview.test.ts tests/naver-blog-exporter.test.ts --silent
