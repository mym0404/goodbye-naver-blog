...
| `se2-table-rawhtml-navigation` | `2` | `se2-paragraph`, `se2-image`, `se2-table`, `case:se2-inline-gif-video` | SE2 table과 인라인 GIF video 사례 해소가 함께 반영된 실제 본문을 검증한다. |
...
| `se3-quote-table-vita` | `3` | `se3-paragraph`, `se3-divider`, `se3-image`, `se3-quote`, `se3-table`, `case:se3-horizontal-line-default`, `case:se3-horizontal-line-line5`, `case:se3-oglink-og_bSize` | SE3 table, quote와 대표 사례 3건의 해소 출력이 함께 반영된 게임 리뷰 글을 검증한다. |
